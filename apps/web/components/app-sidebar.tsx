      ...
      >
        ...
        >
          {!collapsed ? (
            ...
            <Link
              href="/"
              className="flex h-8 w-8 items-center justify-center text-sm font-semibold tracking-tight text-foreground transition-opacity duration-150 hover:opacity-80"
              aria-label="Isotope"
            >
              I
            </Link>
